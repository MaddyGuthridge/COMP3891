For most of the [[README|OS course]], it is assumed that we're running on a single processor system (this is the case in UNSW's version of [[os-161]], but of course it's always more complicated than that.
